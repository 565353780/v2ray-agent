...
menu() {
  ...
  echoContent green "作者：chLi"
  echoContent green "当前版本：v3.0.1"
  echoContent green "Github：https://github.com/565353780/v2ray-agent"
